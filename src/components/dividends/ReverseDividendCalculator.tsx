...
const PORTFOLIO_SUGGESTIONS: PortfolioSuggestion[] = [
  {
    ...
    yield: 10,
    growthRate: 0,
    description: 'Maximum current income with covered call ETFs and high-yield REITs',
    risk: 'Medium',
    icon: <DollarSign className="h-5 w-5" />,
    holdings: [
      { symbol: 'QYLD', allocation: 30, yield: 12.0, type: 'Covered Call' },
      { symbol: 'JEPI', allocation: 25, yield: 8.0, type: 'Premium Income' },
      { symbol: 'JEPQ', allocation: 20, yield: 9.0, type: 'Premium Income' },
      { symbol: 'O', allocation: 15, yield: 5.6, type: 'REIT' },
      { symbol: 'AGNC', allocation: 10, yield: 14.5, type: 'mREIT' },
    ],
  },
  {
    ...
    yield: 3.5,
    growthRate: 8,
    description: 'Focus on growing dividends with aristocrats and growth ETFs',
    risk: 'Low',
    icon: <TrendingUp className="h-5 w-5" />,
    holdings: [
      { symbol: 'SCHD', allocation: 35, yield: 3.5, type: 'Dividend ETF' },
      { symbol: 'VIG', allocation: 25, yield: 1.8, type: 'Dividend Growth' },
      { symbol: 'JNJ', allocation: 15, yield: 3.0, type: 'Aristocrat' },
      { symbol: 'PG', allocation: 15, yield: 2.4, type: 'Aristocrat' },
  ...
  },
  {
    ...
    yield: 5.5,
    growthRate: 4,
    description: 'Balance between current yield and dividend growth',
    risk: 'Medium',
    icon: <Shield className="h-5 w-5" />,
    holdings: [
      { symbol: 'SCHD', allocation: 30, yield: 3.5, type: 'Dividend ETF' },
      { symbol: 'JEPI', allocation: 25, yield: 8.0, type: 'Premium Income' },
      { symbol: 'VYM', allocation: 20, yield: 3.0, type: 'Value ETF' },
      { symbol: 'O', allocation: 15, yield: 5.6, type: 'REIT' },
      { symbol: 'HDV', allocation: 10, yield: 4.0, type: 'High Dividend' },
    ],
  },
  {
    name: 'Growth + Income',
    yield: 2.5,
    growthRate: 10,
    description: 'Lower yield but high growth potential for long-term wealth',
    risk: 'Medium',
    icon: <Sparkles className="h-5 w-5" />,
    holdings: [
      { symbol: 'VIG', allocation: 30, yield: 1.8, type: 'Dividend Growth' },
      { symbol: 'DGRO', allocation: 25, yield: 2.3, type: 'Dividend Growth' },
      { symbol: 'MSFT', allocation: 15, yield: 0.8, type: 'Tech' },
      { symbol: 'AAPL', allocation: 15, yield: 0.5, type: 'Tech' },
      { symbol: 'SCHD', allocation: 15, yield: 3.5, type: 'Dividend ETF' },
    ],
  },
];
