...
export default function AlertHistory() {
  ...
  if (authLoading) {
    return (
      <PageLayout title="Alert History">
  ...
  return (
    <PageLayout title="Alert History">
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-primary/10 via-accent/5 to-background p-6 border border-border/50">
          ...
          <div className="relative">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-muted-foreground">View all your past triggered alerts</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Card className="glass-card group hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5">
              ...
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-muted-foreground text-sm max-w-sm">
                  {searchTerm || filterType !== 'all' 
                    ...
                    : 'Set up price alerts on your Portfolio page to get notified when stocks hit your targets.'}
                </p>
              </div>
            ) : (
